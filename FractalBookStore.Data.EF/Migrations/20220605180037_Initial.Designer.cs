...
namespace FractalBookStore.Data.EF.Migrations
{
    ...
    [Migration("20220605180037_Initial")]
            ...
            modelBuilder.Entity("FractalBookStore.DataTransferObjects.BookDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Image = "https://images-na.ssl-images-amazon.com/images/I/4134nzlpaDL._SX218_BO1,204,203,200_QL40_FMwebp_.jpg",
                            Isbn = "ISBN1211031013",
                            Price = 13.19m,
